...
$sql = "SELECT * FROM user ORDER BY us_id DESC";
    ...
    <div class="my-auto">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <a href="form_user.php" class="btn btn-primary ">ເພິ່ມຂໍ້ມູນ</a>
            </div>
            <div class="card-body">
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <button type="button" class="btn btn-danger delete"
                                            id="<?php echo $row['us_id'] ?>">ລົບ</button>
                                        <a class="btn btn-warning"
                                            href="select_update_user.php?select_id=<?php echo $row['us_id'] ?>">ແກ້ໄຂ້</a>
                                    </div>
                                </td>
