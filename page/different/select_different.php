...
$sql = "SELECT * FROM different ORDER BY di_id DESC";
...
<body id="page-top">
    ...
    <div class="my-auto">
        ...
        <div class="card shadow mb-4">
            <h6 class="m-0 font-weight-bold w-100 text-center fs-4 text-primary">ຂໍ້ມູນ ແຂວງ</h6>
            <div class="card-header py-3">

                <a href="form_different.php" class="btn btn-primary ">ເພິ່ມຂໍ້ມູນ</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($query)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <img class="img-profile img" src="../../img/<?php echo $row['di_img'] ?>"
                                            alt="user">
                                    </td>
                                    <td>
                                        <?php echo $row['di_fname'] . " " . $row['di_lname'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['di_dob'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['di_soso'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['di_pn'] ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            <button type="button" class="btn btn-danger delete"
                                                id="<?php echo $row['di_id'] ?>">ລົບ</button>
                                            <a class="btn btn-warning"
                                                href="select_update_different.php?select_id=<?php echo $row['di_id'] ?>">ແກ້ໄຂ້</a>
                                        </div>
                                    </td>
