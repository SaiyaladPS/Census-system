...
VALUES ('" . $ci_img . "','" . $ci_fname . "','" . $ci_lname . "','" . $ci_gander . "','" . $ci_tel . "','" . $vi_id . "','" . $ci_date . "','" . $ci_dob . "','" . $pro_id . "','" . $dis_id . "','" . $pe_how . "','" . $ci_son . "','" . $ci_soso . "','" . $ci_sol . "','" . $ci_sll . "','" . $ci_aso . "',curdate(),'ແຕ່ງດອງ')";
$query = mysqli_query($conn, $sql);
if ($query) {
    $sql_update = "UPDATE `citizens` SET `ci_how`='" . $pe_how . "',`ci_out` =curdate() WHERE ci_id = '" . $ci_id . "'";
