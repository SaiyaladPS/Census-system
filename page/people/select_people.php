...
<body id="page-top">
    ...
    <div class="my-auto">
        ...
        <div class="card shadow mb-4">
            <h6 class="m-0 font-weight-bold w-100 text-center fs-4 text-primary">ຂໍ້ມູນ ເລກເຮືອນ</h6>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <a type="button" class="btn btn-danger"
                                            href="select_remove_people.php?select_id=<?php echo $row['ci_how'] ?>">ແຈ້ງຄົນຫຼຸດ</a>
                                        <a class="btn btn-success"
                                            href="select_add_people.php?select_id=<?php echo $row['ci_how'] ?>">ແຈ້ງຄົນເພິ່ມ</a>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
