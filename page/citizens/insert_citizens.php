...
if (isset($_FILES["img"]) && $_FILES["img"]["error"] == 0) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["img"]["tmp_name"], $targetFile)) {
            ...
            VALUES ('" . basename($targetFile) . "','" . $ci_fname . "','" . $ci_lname . "','" . $ci_gander . "','" . $ci_tel . "','" . $vi_id . "','" . $ci_date . "','" . $ci_dob . "','" . $pro_id . "','" . $dis_id . "','" . $ci_how . "','" . $ci_son . "','" . $ci_soso . "','" . $ci_sol . "','" . $ci_sll . "','" . $ci_aso . "','','','ຫົວໜ້າຄອບຄົວ')";
