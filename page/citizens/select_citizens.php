...
$sql = "SELECT * FROM citizens as p1 INNER JOIN province as p2 ON p1.pro_id = p2.pro_id INNER JOIN district as p3 ON p1.dis_id = p3.dis_id INNER JOIN village as p4 ON p1.vi_id = p4.vi_id ORDER BY p1.ci_id DESC";
    ...
    <div class="my-auto">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <a href="form_citizens.php" class="btn btn-success">ເພິ່ມຂໍ້ມູນ</a>
            </div>
            <div class="card-body">
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <button type="button" class="btn btn-danger delete"
                                            id="<?php echo $row['ci_id'] ?>">ລົບ</button>
                                        <a class="btn btn-warning"
                                            href="select_update_citizens.php?select_id=<?php echo $row['ci_id'] ?>">ແກ້ໄຂ້</a>
                                    </div>
                                </td>
