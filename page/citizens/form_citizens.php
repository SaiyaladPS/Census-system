                    ...
                    <div class="mb-3">
                        ...
                        <div class=" form-control ">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ci_gander" id="inlineRadio1"
                                    value="Girl">
                                <label class="form-check-label" for="inlineRadio1">ຍິງ</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ci_gander" id="inlineRadio2"
                                    value="Male">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data > 0) {
                        Swal.fire({
                            icon: "warning",
                            title: "ເລືອກບ້ານນີ້ໄດ້ອອກສຳມະໂນໄປແລ້ວ",
