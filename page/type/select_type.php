...
$sql = "SELECT * FROM type ORDER BY ty_id DESC";
    ...
    <div class="my-auto">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <a href="form_type.php" class="btn btn-primary ">ເພິ່ມຂໍ້ມູນ</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($query)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $row['ty_name'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row['ty_remak'] ?>
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            <button type="button" class="btn btn-danger delete"
                                                id="<?php echo $row['ty_id'] ?>">ລົບ</button>
                                            <a class="btn btn-warning"
                                                href="select_update_type.php?select_id=<?php echo $row['ty_id'] ?>">ແກ້ໄຂ້</a>
                                        </div>
                                    </td>
