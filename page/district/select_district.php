...
$sql = "SELECT * 
FROM province AS p1
INNER JOIN district AS p2 ON p1.pro_id = p2.pro_id
ORDER BY p1.pro_id DESC;";
...
<body id="page-top">
    ...
    <div class="my-auto">
        ...
        <div class="card shadow mb-4">
            <h6 class="m-0 font-weight-bold w-100 text-center fs-4 text-primary">ຂໍ້ມູນ ເມືອງ</h6>
            <div class="card-header py-3">

                <a href="form_district.php" class="btn btn-primary ">ເພິ່ມຂໍ້ມູນ</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($query)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $row['pro_remak'] ?>
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            <button type="button" class="btn btn-danger delete"
                                                id="<?php echo $row['dis_id'] ?>">ລົບ</button>
                                            <a class="btn btn-warning"
                                                href="select_update_district.php?select_id=<?php echo $row['dis_id'] ?>">ແກ້ໄຂ້</a>
                                        </div>
                                    </td>
